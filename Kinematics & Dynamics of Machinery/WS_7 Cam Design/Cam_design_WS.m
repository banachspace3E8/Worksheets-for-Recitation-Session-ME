...
%--------------------------------------
%Q. What is the above lines of code trying to generate?
%Ans: ---
%Q. Is 'createplot()' an inbuilt matlab function?
%Ans: ---
%Q. In the last plot function we only plot the final dwell for the cam. Why
%how does the follower profile have all the section plotted?
%Ans: ---
%------------------------------------------------
%------------------------------------------------
...
figure(2)
%--------------------------------------
%Q. Use the r and theta information from above to create the plot of Cam
%Profile.
...
%--------------------------------------
%Q. In the line above, why did we need to specify the length for theta
%vector?
%Ans: ---
%--------------------------------------
subplot(2,1,2)
...
subplot(2,1,2)
%Q. Using the accelerationRise() and accelerationReturn() functions
%provided below, create the plot for the acceleration profile of the cam.
...
figure(5)
subplot(2,1,1)
%Q. Using the 'jerk' variable, write the code to evaluate the plot for the
%jerk profile of the cam
...
%--------------------------------------
%Q. All the functions above use a special technique for evaluating the
%parameters. What is this technique called?
%Ans: ---
%--------------------------------------
%----------------------------------------------
